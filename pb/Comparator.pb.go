...
func (x *BinaryComponentComparator) Reset() {
	*x = BinaryComponentComparator{}
	if protoimpl.UnsafeEnabled {
		mi := &file_Comparator_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BinaryComponentComparator) Descriptor() ([]byte, []int) {
	return file_Comparator_proto_rawDescGZIP(), []int{10}
}
...
var file_Comparator_proto_rawDesc = []byte{
	...
	,
	...
	0x02, 0x28, 0x0d, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x42, 0x4d, 0x0a, 0x31, 0x6f,
	...
	0x42, 0x10, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x50, 0x72, 0x6f, 0x74,
...
var file_Comparator_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_Comparator_proto_goTypes = []interface{}{
	...
	(*BigDecimalComparator)(nil),      // 10: pb.BigDecimalComparator
	(*BinaryComponentComparator)(nil), // 11: pb.BinaryComponentComparator
}
var file_Comparator_proto_depIdxs = []int32{
	...
	2, // 5: pb.BigDecimalComparator.comparable:type_name -> pb.ByteArrayComparable
...
func file_Comparator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_Comparator_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BinaryComponentComparator); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
